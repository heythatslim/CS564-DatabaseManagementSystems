...
void testEmptyTree();
void testOneTree();
void myCreateRelationForward(int size);
void myCreateRelationRandom(int size);
void MyIndexTests(int input);
void intTestsEmpty();
void intTestsOne();
void intTestsNeg();
...
{
  std::cout << "---------------------" << std::endl;
	std::cout << "test for one" << std::endl;
	myCreateRelationRandom(500);
	MyIndexTests(1);
	deleteRelation();
}
